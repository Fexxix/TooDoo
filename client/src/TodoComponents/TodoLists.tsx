...
export default function TodooLists(props:any) {
  ...
  return (
    <>
      ...
      >
        <div onClick={()=>{setTodosList([])}} className="cursor-pointer my-4 text-white relative left-0 w-fit h-fit  py-3 px-4 bg-orange-400 rounded-full hover:bg-orange-600 transform hover:scale-110 hover:scale-x-125 transition-transform duration-300 ease-in-out ">
          clear all
        </div>
